# This Makefile is for the Robot::Perl extension to perl.
#
...
#     ABSTRACT => q[A RobotC wrapper written for the Vex PIC]
#     AUTHOR => [q[James Albert]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => { ExtUtils::MakeMaker=>q[6.63] }
#     DISTNAME => q[Robot-Perl]
#     EXE_FILES => []
#     LICENSE => q[perl]
#     NAME => q[Robot::Perl]
#     PREREQ_PM => {  }
...
INST_LIBDIR      = $(INST_LIB)/Robot
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Robot
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''A RobotC wrapper written for the Vex PIC'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''James Albert'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'build_requires: {}' >> META_new.yml
	$(NOECHO) $(ECHO) 'configure_requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  ExtUtils::MakeMaker: 6.63' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Robot-Perl' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "A RobotC wrapper written for the Vex PIC",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "James Albert"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Robot-Perl",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "ExtUtils::MakeMaker" : "6.63"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      },' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>A RobotC wrapper written for the Vex PIC</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>James Albert</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  robot.pl $(INST_LIB)/Robot/robot.pl 
